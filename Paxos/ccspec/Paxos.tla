...
StateNum == TLCSet("exit",TLCGet("distinct")>200)
NA == Cardinality(Acceptor) \* number of a \in Acceptor

Quorum == {Q \in SUBSET Acceptor : Cardinality(Q) * 2 >= NA + 1}
